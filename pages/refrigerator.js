...
export default function Refrigerator() {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    submitGoogleForm('refrigerator-form');
  };

  return (
    <Layout>
      <Head>
        <title>Refrigerator Service - EasyFix Expert</title>
        <meta name="description" content="Professional refrigerator repair and maintenance services" />
      </Head>
            ...
            <div className="col-lg-6" data-aos="fade-right">
              <div className="position-relative mb-4">
                ...
                <h1 className="display-4 fw-bold mb-4">
                  Refrigerator <span style={{ background: 'linear-gradient(135deg, #17a2b8 0%, #0dcaf0 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Repair Service</span>
                </h1>
              </div>
              <p className="lead mb-4">
                Expert refrigerator repair and maintenance services for all brands and models. Fast, reliable, and affordable solutions at your doorstep.
              </p>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="display-5 fw-bold">Refrigerator Solutions</h2>
            <p className="lead mx-auto" style={{ maxWidth: '700px' }}>
              We provide comprehensive refrigerator repair and maintenance services
            </p>
          </div>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4 text-center">
                  ...
                  <p className="mb-3">
                    Our expert technicians can diagnose and fix any refrigerator issue quickly and efficiently.
                  </p>
                  <ul className="list-unstyled text-start mb-4">
                    ...
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                      <span>Ice maker issues</span>
                    </li>
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                      <span>Water dispenser repair</span>
                    </li>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4 text-center">
                  ...
                  <p className="mb-3">
                    Professional refrigerant gas refilling for all types of refrigerators.
                  </p>
                  <ul className="list-unstyled text-start mb-4">
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4 text-center">
                  ...
                  <p className="mb-3">
                    Regular maintenance to keep your refrigerator running efficiently and extend its lifespan.
                  </p>
                  <ul className="list-unstyled text-start mb-4">
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                    ...
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                      <span>Door seal inspection</span>
                    </li>
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                    ...
                    <li className="d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                      <span>Defrost system check</span>
                    </li>
                  </ul>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right">
              ...
              <h2 className="display-5 fw-bold mb-4">Schedule Your Refrigerator Service Today</h2>
              <p className="lead mb-4">
            ...
            <div className="col-lg-6" data-aos="fade-left">
              <div className="card border-0 shadow-lg">
                <div className="card-body p-4">
                  ...
                  <form id="refrigerator-form" onSubmit={handleFormSubmit}>
                      ...
                      <div className="col-md-6">
                        <div className="form-floating mb-3">
                          <select className="form-select" id="service" name="service" required>
                            ...
                            <option value="Refrigerator Repair">Repair</option>
                            <option value="Refrigerator Gas Refilling">Gas Refilling</option>
                            <option value="Refrigerator Maintenance">Maintenance</option>
                          </select>
