...
export default function WashingMachine() {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    submitGoogleForm('washing-machine-form');
  };

  return (
    <Layout>
      <Head>
        <title>Washing Machine Service - EasyFix Expert</title>
        <meta name="description" content="Professional washing machine repair and maintenance services" />
      </Head>
            ...
            <div className="col-lg-6" data-aos="fade-right">
              <div className="position-relative mb-4">
                ...
                <h1 className="display-4 fw-bold mb-4">
                  Washing Machine <span style={{ background: 'linear-gradient(135deg, #17a2b8 0%, #0dcaf0 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Repair Service</span>
                </h1>
              </div>
              <p className="lead mb-4">
                Expert washing machine repair and maintenance services for all brands and models. Fast, reliable, and affordable solutions at your doorstep.
              </p>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="display-5 fw-bold">Washing Machine Solutions</h2>
            <p className="lead mx-auto" style={{ maxWidth: '700px' }}>
              We provide comprehensive washing machine repair and maintenance services
            </p>
          </div>
          ...
          <div className="row g-4">
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4 text-center">
                  ...
                  <p className="mb-3">
                    Our expert technicians can diagnose and fix any washing machine issue quickly and efficiently.
                  </p>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4 text-center">
                  <div className="rounded-circle p-3 d-inline-block mb-3" style={{ background: 'linear-gradient(135deg, rgba(23, 162, 184, 0.1) 0%, rgba(13, 202, 240, 0.2) 100%)' }}>
                    <i className="bi bi-gear text-info fs-3"></i>
                  </div>
                  <h3 className="h4 mb-3">Installation</h3>
                  <p className="mb-3">
                    Professional installation of all types of washing machines with proper setup and testing.
                  </p>
                  <ul className="list-unstyled text-start mb-4">
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                      <span>New machine setup</span>
                    </li>
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
                  ...
                  <a href="#contact" className="btn rounded-pill" style={{ background: 'linear-gradient(135deg, #17a2b8 0%, #0dcaf0 100%)', color: 'white', border: 'none' }}>Book Installation</a>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4 text-center">
                  ...
                  <p className="mb-3">
                    Regular maintenance to keep your washing machine running efficiently and extend its lifespan.
                  </p>
                  <ul className="list-unstyled text-start mb-4">
                    <li className="mb-2 d-flex align-items-center">
                      <i className="bi bi-check-circle-fill text-info me-2"></i>
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <h2 className="fw-bold mb-4">Washing Machine Brands We Service</h2>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right">
              ...
              <h2 className="display-5 fw-bold mb-4">Schedule Your Washing Machine Service Today</h2>
              <p className="lead mb-4">
            ...
            <div className="col-lg-6" data-aos="fade-left">
              <div className="card border-0 shadow-lg">
                <div className="card-body p-4">
                  ...
                  <form id="washing-machine-form" onSubmit={handleFormSubmit}>
                      ...
                      <div className="col-md-6">
                        <div className="form-floating mb-3">
                          <select className="form-select" id="service" name="service" required>
                            ...
                            <option value="Washing Machine Repair">Repair</option>
                            <option value="Washing Machine Installation">Installation</option>
                            <option value="Washing Machine Maintenance">Maintenance</option>
                          </select>
